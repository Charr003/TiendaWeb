...
public class FirebaseStorageServiceImpl implements FirebaseStorageService {
    ...
    private String uploadFile(File file, String carpeta, String fileName) throws IOException { // setea ruta y accede a .jasper
    ...
    private File convertToFile(MultipartFile archivoLocalCliente) throws IOException { // Crear un arch temp
